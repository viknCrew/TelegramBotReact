  ...
  return (
    <td className="whitespace-nowrap px-4 flex gap-2 items-center">
      ...
      <button
        ...
        className="text-white  focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center  dark:focus:ring-blue-800"
        type="button"
      >
        {props.text}{" "}
        <svg
